...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/iNrRX1MDmw)
...
```sh
npx nx serve talent-check-ai
```

To create a production bundle:

```sh
npx nx build talent-check-ai
```

To see all available targets to run for a project, run:

```sh
npx nx show project talent-check-ai
```
